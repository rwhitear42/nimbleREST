...
public class GetInitiators {
	...
	/**
	 * 
	 * Request initiator information from a specified Nimble array.
	 * 
	 ...
	 * 
	 */
	public GetInitiators(String arrayIP, String token) {
	...
	/**
	 * 
	 * Request initiator information from a specified Nimble array whilst overriding 
	 ...
	 * 
	 */
	public GetInitiators(String arrayIP, int tcpPort, String token) {
		this.arrayIP = arrayIP;
	...
	public String getDetail() throws HttpException, IOException {
		...
		request.setUri(NimbleRESTConstants.GET_INITIATORS_URI );
