...
public class GetProtTemplatesDetailScheduleListObject {
	...
	private long num_retain;
	private long num_retain_replica;
	private int period;
	...
	public long getNum_retain() {
		return num_retain;
	}
	
	public void setNum_retain(long num_retain) {
		this.num_retain = num_retain;
	}
	
	public long getNum_retain_replica() {
		return num_retain_replica;
	}
	
	public void setNum_retain_replica(long num_retain_replica) {
