...
public class GetProtectionTemplates {
	...
	/**
	 * 
	 * Request protection template information from a specified Nimble array.
	 * 
	 ...
	 * 
	 */
	public GetProtectionTemplates(String arrayIP, String token) {
	...
	/**
	 * 
	 * Request protection template information from a specified Nimble array whilst overriding 
	 ...
	 * 
	 */
	public GetProtectionTemplates(String arrayIP, int tcpPort, String token) {
		this.arrayIP = arrayIP;
	...
	/**
	 * Request detailed protection template information from a Nimble array.
	 * 
	...
	public String getDetail() throws HttpException, IOException {
		...
		request.setUri(NimbleRESTConstants.GET_PROTECTION_TEMPLATES_URI );
