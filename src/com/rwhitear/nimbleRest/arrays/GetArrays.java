...
public class GetArrays {
	 ...
	 * 
	 */
	public GetArrays(String arrayIP, String token) {
	 ...
	 * 
	 */
	public GetArrays(String arrayIP, int tcpPort, String token) {
		this.arrayIP = arrayIP;
	...
	public String getDetail() throws HttpException, IOException {
		...
		request.setUri(NimbleRESTConstants.GET_ARRAYS_DETAIL_URI );
